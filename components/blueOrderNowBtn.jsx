 ...
 * Features gradient animation, pulsing effect, and shimmer animation in blue.
 */
const BlueOrderNowBtn = () => {
  return (
    <a href='#order' className="relative inline-block w-full mt-4">
      {/* Pulsing glow effect */}
      <div className="absolute inset-0 bg-linear-to-r from-blue-500 via-blue-600 to-cyan-500 rounded-lg blur-md opacity-75 animate-pulse"></div>
...
export default BlueOrderNowBtn;